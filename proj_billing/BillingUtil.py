    ...
    def process_xml(self):
        ...
        if self.xml_type == 'conf_spaces':
           ...
           try:
               ...
               self.logger.error("\033[1;31;40m **** XML Parsing, Line: %d, msg: %s \033[0;37;40m" % (e.getLiineNumber(), e.message)) 
               self.logspk.error("\033[1;31;40m **** XML Parsing, Line: %d, msg: %s \033[0;37;40m" % (e.getLiineNumber(), e.message)) 

           if not self.billdata:
               self.logger.error("\033[0;31;40m **** No Conference room data returned from the XML parser... \033[0;37;40m")
               self.logspk.error("\033[0;31;40m **** No Conference room data returned from the XML parser... \033[0;37;40m")
           else:
           ...
           try:
               ...
               self.logger.error("\033[1;31;40m **** Line: %d, msg: %s \033[0;37;40m" % (e.getLiineNumber(), e.message))
               self.logspk.error("\033[1;31;40m **** Line: %d, msg: %s \033[0;37;40m" % (e.getLiineNumber(), e.message))

           if not self.billdata:
               self.logger.error("\033[1;31;40m **** No Device/User data returned from the XML parser... \033[0;37;40m")
               self.logspk.error("\033[1;31;40m **** No Device/User data returned from the XML parser... \033[0;37;40m")
           else:
    ...
    def _log_all_data_db(self, **tmpdic):
        ...
        if self.xml_type == 'conf_spaces':
           try:
              ...
              inserts_ok = 1
              self.logger.error("\033[1;31;40m **** Insert error for coSpace id: %s, Error: %s \033[0;37;40m" % (tmpdic['coSpace_id'], db_error))
              self.logspk.error("\033[1;31;40m **** Insert error for coSpace id: %s, Error: %s \033[0;37;40m" % (tmpdic['coSpace_id'], db_error))
           ...
           try:
              ...
              inserts_ok = 1
              self.logger.error("\033[1;31;40m **** Insert error for device/usage data on : %s, Error: %s \033[0;37;40m" % (todays_date, db_error))
              self.logspk.error("\033[1;31;40m **** Insert error for device/usage data on : %s, Error: %s \033[0;37;40m" % (todays_date, db_error))
        ...
        if fillog == 'filelog':
            for tmpkey in key_tags:
               if tmpkey not in chk_dic:
                  self.logger.error("\033[1;31;40m **** Missing XML tag, Will not insert into database...")
                  self.logger.error(chk_dic)
                  self.logger.info("\033[0;37;40m")

                  self.logspk.error("\033[1;31;40m **** Missing XML tag, Will not insert into database...")
